...
int main()
{
	...
	//init.
	multimap <int, string> mmap2 = { {101, "Shak"}, {201, "Mama"}, {201, "Legend"} };
	...
	//alter
	// mmap2[201] = "Vallu";            // can't be done



	//insert:- insert key,value.
	//2 approach
	mmap2.insert(pair<int, string>(106, "Trap"));

	mmap2.insert(make_pair(208, "Vazz"));
